...
class _LogListViewState extends State<LogListView>
  ...
  void initState() {
    ...
    counterBloc.getResult.listen((counterListData) {
        setState(() {
          counterList.clear();
          counterList.add(CounterModel(id: 0, name: MyApp.local.log_list_all_counters, value: 0, description: ""));
  ...
  Widget _buildList(BuildContext context) {
    ...
    return Scaffold(
        appBar:  AppBar(
          ...
          title: Text(MyApp.local.log_list_log_file, style: TextStyle(color: AppColors.appPrimaryColorWhite),),
          actions: [
          ],
        ),
        //drawer: MenuView(),
                  ...
                  child: Column(
                    ...
                    children: [
                      (!widget.hasFetched || widget.model.length>0)? Container(): Container(
                          ...
                          child: Text(MyApp.local.log_list_no_entries, style: TextStyle(color: AppColors.appPrimaryColorWhite),)),
